...
# 
# 网络使用示例
# curl -L https://s.asfd.cn/514b875c | bash -s -- https://get.docker.com | bash
# curl -L https://s.asfd.cn/514b875c | CDN=https://fastfile.asfd.cn/ bash -s -- https://get.docker.com | bash
###